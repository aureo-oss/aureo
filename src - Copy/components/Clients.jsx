  ...
  return (
    <div className={`${styles.container} ${darkMode ? styles.dark : ''}`}>
      ...
      <header className={styles.mainHeader}>
        ...
        <button 
          className={`${styles.primaryButton} ${darkMode ? styles.darkButton : ''}`}
          onClick={() => {
            setEditingClient(null);
            setActiveTab('add');
          }}
      ...
      {/* Client List/Form */}
      <div className={`${styles.contentArea} ${darkMode ? styles.darkContent : ''}`}>
        {activeTab === 'list' ? (
            ...
            {filteredClients.length === 0 ? (
              ...
              <div className={styles.clientGrid}>
                {filteredClients.map((client) => (
                  <div key={client.id} className={`${styles.clientCard} ${darkMode ? styles.darkCard : ''}`}>
                    <div className={styles.clientHeader}>
                      ...
                      <div className={styles.clientActions}>
                        <button 
                          className={`${styles.iconButton} ${darkMode ? styles.darkIconButton : ''}`}
                    ...
                    {client.notes && (
                      <div className={`${styles.notesContainer} ${darkMode ? styles.darkNotes : ''}`}>
                        <p>{client.notes}</p>
                      </div>
                    )}
                    ...
                    <div className={styles.clientFooter}>
                      <button
                        className={`${styles.emailButton} ${darkMode ? styles.darkButton : ''}`}
                      ...
                      {showTemplateDropdown && currentClientForEmail?.id === client.id && (
                        <div 
                          ref={dropdownRef}
                          className={`${styles.templateDropdownContainer} ${darkMode ? styles.dark : ''}`}
                        >
          ...
          <div className={`${styles.formContainer} ${darkMode ? styles.darkForm : ''}`}>
            <h2>
            ...
            <form onSubmit={handleAddClient}>
              ...
              <div className={styles.formActions}>
                <button
                  type="button"
                  className={`${styles.secondaryButton} ${darkMode ? styles.darkSecondaryButton : ''}`}
                  onClick={() => {
                    setActiveTab("list");
                    setEditingClient(null);
                  }}
      ...
      {showInvoiceModal && (
        <div className={`${styles.modalOverlay} ${darkMode ? styles.dark : ''}`}>
          <div className={`${styles.invoiceModal} ${darkMode ? styles.dark : ''}`}>
